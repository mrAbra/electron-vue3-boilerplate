            ...
            if (to.path === '/login') {
                ...
                if (hasRoles && routers && routers.length > 0) {
                    ...
                    try {
                        ...
                        console.log("ROUTER AFTER PERMISSONqwefqwe",accessRoutes);
                    ...
                    console.log("ROUTER AFTER PERMISSON", routers);
                }
